...
#    Updated: 2022/01/03 17:23:51 by ahel-mou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = push_swap_main.c\
		...
		./utils/call_action.c ./utils/sort_small_numbers.c ./utils/sort_tmp_arr.c ./utils/pushit_to_topstk.c ./utils/ft_find.c\
		./utils/sort_large_numbers.c
